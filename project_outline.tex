...
To establish a baseline for the number of decisions we let the untrained SAT-solver solve 10000 Sudokus from the datasets. The results are displayed in table 1. %Please add table with results of untrained runs about here.
...
However, in this regard we obtained a negative result: table 2 indicates the number of decisions as well as the classes of learned validities for all three encodings. %Please enter table 2 around here.
